...
public class CoreSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorePackage.NUMERIC_FIELD: {
			...
			case CorePackage.INTEGER_FIELD: {
			...
			case CorePackage.TEXT_AREA_FIELD: {
			...
			case CorePackage.BARCODE_FIELD: {
			...
			case CorePackage.MEDIA_FILE_FIELD: {
			...
			case CorePackage.RELATION_FIELD_ENTITY: {
			...
			case CorePackage.MAIN_RELATION_FIELD_ENTITY: {
			...
			case CorePackage.REVERSE_RELATION_FIELD_ENTITY: {
			...
			case CorePackage.ENUM_VALUE: {
				EnumValue enumValue = (EnumValue)theEObject;
				T result = caseEnumValue(enumValue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CorePackage.BINARY_FIELD: {
			...
			case CorePackage.DATE_TIME_FIELD: {
			...
			case CorePackage.FIELD_DEPENDENT_VISIBILITY: {
