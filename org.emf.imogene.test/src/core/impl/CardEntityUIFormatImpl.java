 ...
 * <ul>
 *   <li>{@link core.impl.CardEntityUIFormatImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link core.impl.CardEntityUIFormatImpl#isWithTabulations <em>With Tabulations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CardEntityUIFormatImpl extends MinimalEObjectImpl.Container implements CardEntityUIFormat {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.CARD_ENTITY_UI_FORMAT;
	}
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.CARD_ENTITY_UI_FORMAT__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(CardEntity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY_UI_FORMAT__ENTITY, oldEntity, entity));
	}
	...
	public void setWithTabulations(boolean newWithTabulations) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY_UI_FORMAT__WITH_TABULATIONS, oldWithTabulations, withTabulations));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.CARD_ENTITY_UI_FORMAT__ENTITY:
				if (resolve) return getEntity();
				return basicGetEntity();
			case CorePackage.CARD_ENTITY_UI_FORMAT__WITH_TABULATIONS:
