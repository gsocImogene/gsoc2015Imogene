 ...
 * <ul>
 *   <li>{@link core.impl.DescriptionImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link core.impl.DescriptionImpl#getHelp <em>Help</em>}</li>
 *   <li>{@link core.impl.DescriptionImpl#getLocale <em>Locale</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DescriptionImpl extends MinimalEObjectImpl.Container implements Description {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.DESCRIPTION;
	}
	...
	public void setDisplay(String newDisplay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DESCRIPTION__DISPLAY, oldDisplay, display));
	}
	...
	public void setHelp(String newHelp) {
		...
		help = newHelp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DESCRIPTION__HELP, oldHelp, help));
	}
	...
	public void setLocale(String newLocale) {
		...
		locale = newLocale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.DESCRIPTION__LOCALE, oldLocale, locale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.DESCRIPTION__DISPLAY:
				return getDisplay();
			case CorePackage.DESCRIPTION__HELP:
				return getHelp();
			case CorePackage.DESCRIPTION__LOCALE:
				return getLocale();
		}
