 ...
 * <ul>
 *   <li>{@link core.impl.LanguageImpl#getName <em>Name</em>}</li>
 *   <li>{@link core.impl.LanguageImpl#getDateFormat <em>Date Format</em>}</li>
 *   <li>{@link core.impl.LanguageImpl#getTimeFormat <em>Time Format</em>}</li>
 *   <li>{@link core.impl.LanguageImpl#getIntegerFormat <em>Integer Format</em>}</li>
 *   <li>{@link core.impl.LanguageImpl#getFloatFormat <em>Float Format</em>}</li>
 *   <li>{@link core.impl.LanguageImpl#getIsoCode <em>Iso Code</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LanguageImpl extends MinimalEObjectImpl.Container implements Language {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.LANGUAGE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.LANGUAGE__NAME, oldName, name));
	}
	...
	public void setDateFormat(String newDateFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.LANGUAGE__DATE_FORMAT, oldDateFormat, dateFormat));
	}
	...
	public void setTimeFormat(String newTimeFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.LANGUAGE__TIME_FORMAT, oldTimeFormat, timeFormat));
	}
	...
	public void setIntegerFormat(String newIntegerFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.LANGUAGE__INTEGER_FORMAT, oldIntegerFormat, integerFormat));
	}
	...
	public void setFloatFormat(String newFloatFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.LANGUAGE__FLOAT_FORMAT, oldFloatFormat, floatFormat));
	}
	...
	public void setIsoCode(String newIsoCode) {
		...
		isoCode = newIsoCode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.LANGUAGE__ISO_CODE, oldIsoCode, isoCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.LANGUAGE__NAME:
				return getName();
			case CorePackage.LANGUAGE__DATE_FORMAT:
				return getDateFormat();
			case CorePackage.LANGUAGE__TIME_FORMAT:
				return getTimeFormat();
			case CorePackage.LANGUAGE__INTEGER_FORMAT:
				return getIntegerFormat();
			case CorePackage.LANGUAGE__FLOAT_FORMAT:
				return getFloatFormat();
			case CorePackage.LANGUAGE__ISO_CODE:
				return getIsoCode();
		}
