 ...
 * <ul>
 *   <li>{@link core.impl.RelationFieldEntityImpl#getEntity <em>Entity</em>}</li>
 *   <li>{@link core.impl.RelationFieldEntityImpl#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link core.impl.RelationFieldEntityImpl#getType <em>Type</em>}</li>
 *   <li>{@link core.impl.RelationFieldEntityImpl#getCommonFields <em>Common Fields</em>}</li>
 *   <li>{@link core.impl.RelationFieldEntityImpl#getOppositeRelationField <em>Opposite Relation Field</em>}</li>
 *   <li>{@link core.impl.RelationFieldEntityImpl#getRelationHierarchicalFilter <em>Relation Hierarchical Filter</em>}</li>
 *   <li>{@link core.impl.RelationFieldEntityImpl#isNestedForm <em>Nested Form</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class RelationFieldEntityImpl extends FieldEntityImpl implements RelationFieldEntity {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.RELATION_FIELD_ENTITY;
	}
		...
		if (entity != null && entity.eIsProxy()) {
			...
			if (entity != oldEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.RELATION_FIELD_ENTITY__ENTITY, oldEntity, entity));
			}
		}
		return entity;
	}
	...
	public void setEntity(CardEntity newEntity) {
		...
		entity = newEntity;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATION_FIELD_ENTITY__ENTITY, oldEntity, entity));
	}
	...
	public void setCardinality(int newCardinality) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATION_FIELD_ENTITY__CARDINALITY, oldCardinality, cardinality));
	}
	...
	public void setType(RelationType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATION_FIELD_ENTITY__TYPE, oldType, type));
	}
	...
	public EList<RelationFieldEntity> getCommonFields() {
		if (commonFields == null) {
			commonFields = new EObjectResolvingEList<RelationFieldEntity>(RelationFieldEntity.class, this, CorePackage.RELATION_FIELD_ENTITY__COMMON_FIELDS);
		}
		return commonFields;
	}
	...
	public RelationFieldEntity getOppositeRelationField() {
		if (oppositeRelationField != null && oppositeRelationField.eIsProxy()) {
			...
			if (oppositeRelationField != oldOppositeRelationField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.RELATION_FIELD_ENTITY__OPPOSITE_RELATION_FIELD, oldOppositeRelationField, oppositeRelationField));
			}
		}
	...
	public void setOppositeRelationField(RelationFieldEntity newOppositeRelationField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATION_FIELD_ENTITY__OPPOSITE_RELATION_FIELD, oldOppositeRelationField, oppositeRelationField));
	}
	...
	public EList<RelationFieldEntity> getRelationHierarchicalFilter() {
		if (relationHierarchicalFilter == null) {
			relationHierarchicalFilter = new EObjectResolvingEList<RelationFieldEntity>(RelationFieldEntity.class, this, CorePackage.RELATION_FIELD_ENTITY__RELATION_HIERARCHICAL_FILTER);
		}
	...
	public void setNestedForm(boolean newNestedForm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.RELATION_FIELD_ENTITY__NESTED_FORM, oldNestedForm, nestedForm));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.RELATION_FIELD_ENTITY__ENTITY:
				if (resolve) return getEntity();
				return basicGetEntity();
			case CorePackage.RELATION_FIELD_ENTITY__CARDINALITY:
				return getCardinality();
			case CorePackage.RELATION_FIELD_ENTITY__TYPE:
				return getType();
			case CorePackage.RELATION_FIELD_ENTITY__COMMON_FIELDS:
				return getCommonFields();
			case CorePackage.RELATION_FIELD_ENTITY__OPPOSITE_RELATION_FIELD:
				if (resolve) return getOppositeRelationField();
				return basicGetOppositeRelationField();
			case CorePackage.RELATION_FIELD_ENTITY__RELATION_HIERARCHICAL_FILTER:
				return getRelationHierarchicalFilter();
			case CorePackage.RELATION_FIELD_ENTITY__NESTED_FORM:
				return isNestedForm();
		}
