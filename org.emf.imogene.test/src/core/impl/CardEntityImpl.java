 ...
 * <ul>
 *   <li>{@link core.impl.CardEntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getShortName <em>Short Name</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getDescriptions <em>Descriptions</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getColumnFields <em>Column Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getMainFields <em>Main Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getSecondaryFields <em>Secondary Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getIcon <em>Icon</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#isTopLevel <em>Top Level</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getClientFilterFields <em>Client Filter Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getGroups <em>Groups</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getSortFields <em>Sort Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getActorFilterFields <em>Actor Filter Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getColor <em>Color</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#isClientPeriodFilterable <em>Client Period Filterable</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getGeoreferenced <em>Georeferenced</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getRdfSubject <em>Rdf Subject</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getRdfPredicate <em>Rdf Predicate</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#getNestedFields <em>Nested Fields</em>}</li>
 *   <li>{@link core.impl.CardEntityImpl#isHasDynamicFields <em>Has Dynamic Fields</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CardEntityImpl extends MinimalEObjectImpl.Container implements CardEntity {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.CARD_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__NAME, oldName, name));
	}
	...
	public void setShortName(String newShortName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__SHORT_NAME, oldShortName, shortName));
	}
	...
	public EList<Description> getDescriptions() {
		if (descriptions == null) {
			descriptions = new EObjectContainmentEList<Description>(Description.class, this, CorePackage.CARD_ENTITY__DESCRIPTIONS);
		}
		return descriptions;
	}
	...
	public EList<FieldEntity> getColumnFields() {
		if (columnFields == null) {
			columnFields = new EObjectResolvingEList<FieldEntity>(FieldEntity.class, this, CorePackage.CARD_ENTITY__COLUMN_FIELDS);
		}
		return columnFields;
	}
	...
	public EList<FieldEntity> getMainFields() {
		if (mainFields == null) {
			mainFields = new EObjectResolvingEList<FieldEntity>(FieldEntity.class, this, CorePackage.CARD_ENTITY__MAIN_FIELDS);
		}
		return mainFields;
	}
	...
	public EList<FieldEntity> getSecondaryFields() {
		if (secondaryFields == null) {
			secondaryFields = new EObjectResolvingEList<FieldEntity>(FieldEntity.class, this, CorePackage.CARD_ENTITY__SECONDARY_FIELDS);
		}
	...
	public void setIcon(String newIcon) {
		...
		icon = newIcon;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__ICON, oldIcon, icon));
	}
	...
	public void setTopLevel(boolean newTopLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__TOP_LEVEL, oldTopLevel, topLevel));
	}
	...
	public EList<FieldEntity> getClientFilterFields() {
		if (clientFilterFields == null) {
			clientFilterFields = new EObjectResolvingEList<FieldEntity>(FieldEntity.class, this, CorePackage.CARD_ENTITY__CLIENT_FILTER_FIELDS);
		}
	...
	public EList<FieldGroup> getGroups() {
		if (groups == null) {
			groups = new EObjectContainmentWithInverseEList<FieldGroup>(FieldGroup.class, this, CorePackage.CARD_ENTITY__GROUPS, CorePackage.FIELD_GROUP__PARENT_CARD);
		}
		return groups;
	}
	...
	public EList<FieldEntity> getSortFields() {
		if (sortFields == null) {
			sortFields = new EObjectResolvingEList<FieldEntity>(FieldEntity.class, this, CorePackage.CARD_ENTITY__SORT_FIELDS);
		}
		return sortFields;
	}
	...
	public EList<ActorFilter> getActorFilterFields() {
		if (actorFilterFields == null) {
			actorFilterFields = new EObjectResolvingEList<ActorFilter>(ActorFilter.class, this, CorePackage.CARD_ENTITY__ACTOR_FILTER_FIELDS);
		}
	...
	public void setColor(String newColor) {
		...
		color = newColor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__COLOR, oldColor, color));
	}
	...
	public void setClientPeriodFilterable(boolean newClientPeriodFilterable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__CLIENT_PERIOD_FILTERABLE, oldClientPeriodFilterable, clientPeriodFilterable));
	}
	...
	public GeoField getGeoreferenced() {
		if (georeferenced != null && georeferenced.eIsProxy()) {
			...
			if (georeferenced != oldGeoreferenced) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.CARD_ENTITY__GEOREFERENCED, oldGeoreferenced, georeferenced));
			}
		}
	...
	public void setGeoreferenced(GeoField newGeoreferenced) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__GEOREFERENCED, oldGeoreferenced, georeferenced));
	}
	...
	public RelationFieldEntity getRdfSubject() {
		if (rdfSubject != null && rdfSubject.eIsProxy()) {
			...
			if (rdfSubject != oldRdfSubject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.CARD_ENTITY__RDF_SUBJECT, oldRdfSubject, rdfSubject));
			}
		}
		return rdfSubject;
	}
	...
	public void setRdfSubject(RelationFieldEntity newRdfSubject) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__RDF_SUBJECT, oldRdfSubject, rdfSubject));
	}
	...
	public void setRdfPredicate(String newRdfPredicate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__RDF_PREDICATE, oldRdfPredicate, rdfPredicate));
	}
	...
	public EList<FieldEntity> getNestedFields() {
		if (nestedFields == null) {
			nestedFields = new EObjectResolvingEList<FieldEntity>(FieldEntity.class, this, CorePackage.CARD_ENTITY__NESTED_FIELDS);
		}
		return nestedFields;
	}
	...
	public void setHasDynamicFields(boolean newHasDynamicFields) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CARD_ENTITY__HAS_DYNAMIC_FIELDS, oldHasDynamicFields, hasDynamicFields));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.CARD_ENTITY__GROUPS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.CARD_ENTITY__DESCRIPTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.CARD_ENTITY__NAME:
				return getName();
			case CorePackage.CARD_ENTITY__SHORT_NAME:
				return getShortName();
			case CorePackage.CARD_ENTITY__DESCRIPTIONS:
				return getDescriptions();
			case CorePackage.CARD_ENTITY__COLUMN_FIELDS:
				return getColumnFields();
			case CorePackage.CARD_ENTITY__MAIN_FIELDS:
				return getMainFields();
			case CorePackage.CARD_ENTITY__SECONDARY_FIELDS:
				return getSecondaryFields();
			case CorePackage.CARD_ENTITY__ICON:
				return getIcon();
			case CorePackage.CARD_ENTITY__TOP_LEVEL:
				return isTopLevel();
			case CorePackage.CARD_ENTITY__CLIENT_FILTER_FIELDS:
				return getClientFilterFields();
			case CorePackage.CARD_ENTITY__GROUPS:
				return getGroups();
			case CorePackage.CARD_ENTITY__SORT_FIELDS:
				return getSortFields();
			case CorePackage.CARD_ENTITY__ACTOR_FILTER_FIELDS:
				return getActorFilterFields();
			case CorePackage.CARD_ENTITY__COLOR:
				return getColor();
			case CorePackage.CARD_ENTITY__CLIENT_PERIOD_FILTERABLE:
				return isClientPeriodFilterable();
			case CorePackage.CARD_ENTITY__GEOREFERENCED:
				if (resolve) return getGeoreferenced();
				return basicGetGeoreferenced();
			case CorePackage.CARD_ENTITY__RDF_SUBJECT:
				if (resolve) return getRdfSubject();
				return basicGetRdfSubject();
			case CorePackage.CARD_ENTITY__RDF_PREDICATE:
				return getRdfPredicate();
			case CorePackage.CARD_ENTITY__NESTED_FIELDS:
				return getNestedFields();
			case CorePackage.CARD_ENTITY__HAS_DYNAMIC_FIELDS:
