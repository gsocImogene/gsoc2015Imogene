 ...
 * <ul>
 *   <li>{@link core.impl.ValidationRuleImpl#getValidationRegularExpression <em>Validation Regular Expression</em>}</li>
 *   <li>{@link core.impl.ValidationRuleImpl#getDescriptions <em>Descriptions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValidationRuleImpl extends MinimalEObjectImpl.Container implements ValidationRule {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.VALIDATION_RULE;
	}
	...
	public void setValidationRegularExpression(String newValidationRegularExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.VALIDATION_RULE__VALIDATION_REGULAR_EXPRESSION, oldValidationRegularExpression, validationRegularExpression));
	}
	...
	public EList<Description> getDescriptions() {
		if (descriptions == null) {
			descriptions = new EObjectContainmentEList<Description>(Description.class, this, CorePackage.VALIDATION_RULE__DESCRIPTIONS);
		}
		return descriptions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CorePackage.VALIDATION_RULE__DESCRIPTIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.VALIDATION_RULE__VALIDATION_REGULAR_EXPRESSION:
