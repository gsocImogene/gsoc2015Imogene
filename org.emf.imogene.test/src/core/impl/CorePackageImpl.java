...
import core.AddressField;
import core.BarcodeField;
import core.BinaryField;
import core.BooleanField;
import core.CardEntity;
import core.CardEntityUIFormat;
import core.CoreFactory;
import core.CorePackage;
import core.DateField;
import core.DateTimeField;
import core.DatesField;
import core.Description;
import core.EmailField;
...
import core.GeoType;
import core.IntegerField;
import core.Language;
import core.MainRelationFieldEntity;
import core.MediaFileField;
import core.NotificationInfo;
import core.NotificationMethod;
import core.NumericField;
import core.PhoneField;
import core.PhoneType;
import core.PhotoField;
import core.Project;
import core.RelationFieldEntity;
import core.RelationType;
import core.ReverseRelationFieldEntity;
import core.SoundField;
import core.StringField;
import core.TextAreaField;
import core.TextField;
import core.Thema;
import core.TimeField;
import core.ValidationRule;
import core.VideoField;
...
public class CorePackageImpl extends EPackageImpl implements CorePackage {
	 ...
	 * @generated
	 */
	public EOperation getFieldGroup__ContainsOnlyHiddenFields() {
		return fieldGroupEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getFieldEntity__Validate() {
		return fieldEntityEClass.getEOperations().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(fieldGroupEClass, FIELD_GROUP___CONTAINS_ONLY_HIDDEN_FIELDS);
		...
		createEOperation(fieldEntityEClass, FIELD_ENTITY___VALIDATE);
	...
	public void initializePackageContents() {
		...
		initEOperation(getFieldGroup__ContainsOnlyHiddenFields(), ecorePackage.getEBoolean(), "containsOnlyHiddenFields", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getFieldEntity__Validate(), null, "validate", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getGeoField_Type(), this.getGeoType(), "type", "Nothing", 1, 1, GeoField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getPhoneField_PhoneType(), this.getPhoneType(), "phoneType", "PhoneNumber", 1, 1, PhoneField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(phoneTypeEEnum, PhoneType.PHONE_NUMBER);
		addEEnumLiteral(phoneTypeEEnum, PhoneType.FAX_NUMBER);
		addEEnumLiteral(phoneTypeEEnum, PhoneType.MOBILE_NUMBER);
		addEEnumLiteral(phoneTypeEEnum, PhoneType.FIXE_NUMBER);
		...
		addEEnumLiteral(notificationMethodEEnum, NotificationMethod.SMS_METHOD);
		addEEnumLiteral(notificationMethodEEnum, NotificationMethod.MAIL_METHOD);
		addEEnumLiteral(notificationMethodEEnum, NotificationMethod.DEFAULT_METHOD);
		addEEnumLiteral(notificationMethodEEnum, NotificationMethod.VOCAL_METHOD);
		addEEnumLiteral(notificationMethodEEnum, NotificationMethod.WEB_SERVICE_METHOD);
