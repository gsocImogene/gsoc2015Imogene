 ...
 * <ul>
 *   <li>{@link core.impl.NotificationInfoImpl#getDataField <em>Data Field</em>}</li>
 *   <li>{@link core.impl.NotificationInfoImpl#getMethod <em>Method</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NotificationInfoImpl extends MinimalEObjectImpl.Container implements NotificationInfo {
	/**
	 ...
	 * @ordered
	 */
	protected static final NotificationMethod METHOD_EDEFAULT = NotificationMethod.SMS_METHOD;
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.NOTIFICATION_INFO;
	}
		...
		if (dataField != null && dataField.eIsProxy()) {
			...
			if (dataField != oldDataField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.NOTIFICATION_INFO__DATA_FIELD, oldDataField, dataField));
			}
		}
		return dataField;
	}
	...
	public void setDataField(FieldEntity newDataField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.NOTIFICATION_INFO__DATA_FIELD, oldDataField, dataField));
	}
	...
	public void setMethod(NotificationMethod newMethod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.NOTIFICATION_INFO__METHOD, oldMethod, method));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.NOTIFICATION_INFO__DATA_FIELD:
				if (resolve) return getDataField();
				return basicGetDataField();
			case CorePackage.NOTIFICATION_INFO__METHOD:
				return getMethod();
		}
