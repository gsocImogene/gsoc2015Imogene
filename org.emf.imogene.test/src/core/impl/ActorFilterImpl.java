 ...
 * <ul>
 *   <li>{@link core.impl.ActorFilterImpl#getEntityField <em>Entity Field</em>}</li>
 *   <li>{@link core.impl.ActorFilterImpl#getActorField <em>Actor Field</em>}</li>
 *   <li>{@link core.impl.ActorFilterImpl#isSufficient <em>Sufficient</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ActorFilterImpl extends MinimalEObjectImpl.Container implements ActorFilter {
	/**
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ACTOR_FILTER;
	}
		...
		if (entityField != null && entityField.eIsProxy()) {
			...
			if (entityField != oldEntityField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.ACTOR_FILTER__ENTITY_FIELD, oldEntityField, entityField));
			}
		}
		return entityField;
	}
	...
	public void setEntityField(RelationFieldEntity newEntityField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ACTOR_FILTER__ENTITY_FIELD, oldEntityField, entityField));
	}
	...
	public FilterField getActorField() {
		if (actorField != null && actorField.eIsProxy()) {
			...
			if (actorField != oldActorField) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CorePackage.ACTOR_FILTER__ACTOR_FIELD, oldActorField, actorField));
			}
		}
		return actorField;
	}
	...
	public void setActorField(FilterField newActorField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ACTOR_FILTER__ACTOR_FIELD, oldActorField, actorField));
	}
	...
	public void setSufficient(boolean newSufficient) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ACTOR_FILTER__SUFFICIENT, oldSufficient, sufficient));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.ACTOR_FILTER__ENTITY_FIELD:
				if (resolve) return getEntityField();
				return basicGetEntityField();
			case CorePackage.ACTOR_FILTER__ACTOR_FIELD:
				if (resolve) return getActorField();
				return basicGetActorField();
			case CorePackage.ACTOR_FILTER__SUFFICIENT:
				return isSufficient();
		}
