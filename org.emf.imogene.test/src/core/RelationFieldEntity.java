 ...
 * <ul>
 *   <li>{@link core.RelationFieldEntity#getEntity <em>Entity</em>}</li>
 *   <li>{@link core.RelationFieldEntity#getCardinality <em>Cardinality</em>}</li>
 *   <li>{@link core.RelationFieldEntity#getType <em>Type</em>}</li>
 *   <li>{@link core.RelationFieldEntity#getCommonFields <em>Common Fields</em>}</li>
 *   <li>{@link core.RelationFieldEntity#getOppositeRelationField <em>Opposite Relation Field</em>}</li>
 *   <li>{@link core.RelationFieldEntity#getRelationHierarchicalFilter <em>Relation Hierarchical Filter</em>}</li>
 *   <li>{@link core.RelationFieldEntity#isNestedForm <em>Nested Form</em>}</li>
 * </ul>
 * </p>
 *
 * @see core.CorePackage#getRelationFieldEntity()
 * @model abstract="true"
...
public interface RelationFieldEntity extends FieldEntity {
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_Entity()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link core.RelationFieldEntity#getEntity <em>Entity</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_Cardinality()
	...
	/**
	 * Sets the value of the '{@link core.RelationFieldEntity#getCardinality <em>Cardinality</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link core.RelationType}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_Type()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link core.RelationFieldEntity#getType <em>Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link core.RelationFieldEntity}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_CommonFields()
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_OppositeRelationField()
	...
	/**
	 * Sets the value of the '{@link core.RelationFieldEntity#getOppositeRelationField <em>Opposite Relation Field</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_RelationHierarchicalFilter()
	 * @model
	 * @generated
	 */
	 ...
	 * @see core.CorePackage#getRelationFieldEntity_NestedForm()
	 * @model default="false"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link core.RelationFieldEntity#isNestedForm <em>Nested Form</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
