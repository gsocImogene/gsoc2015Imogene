...
public class MobileAppGenAction implements IObjectActionDelegate {
	
	Shell shell;
	private static final String PROJECT_NAME = "org.imogene.mobileApp";

	public MobileAppGenAction() {
